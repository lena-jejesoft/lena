...
const STACKED_AREA_CHART_COLORS: string[] = [
  "#C15F3C",
  "#B1ADA1",
  "#7D8471",
  "#9B8AA6",
...
export function ChartCoreStackedAreaRenderer({
  data,
  style,
  height,
  onLegendStateChange,
  ...
  const palette = style?.colorPalette?.length ? style.colorPalette : STACKED_AREA_CHART_COLORS;
