...
import type { TimepointRankingBarData } from "./recharts-adapter";
import {
  Select,
  SelectContent,
  SelectItem,
...
export function RechartsRankingBarWrapper({
  ...
  const isTimepointMode = timepointData && timepointData.length > 1;
  ...
  }, [isTimepointMode, selectedTimepoint, timepointData, onRankingDataChange]);
  ...
  const activeData = useMemo(() => {
    ...
    return data;
  }, [isTimepointMode, selectedTimepoint, timepointData, data, xField, yField]);
