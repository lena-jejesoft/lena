...
const STACKED_CHART_COLORS: string[] = [
  "#C15F3C",
  "#B1ADA1",
  "#7D8471",
  "#9B8AA6",
...
export function ChartCoreStackedWrapperRenderer({
  data,
  style,
  height,
  onLegendStateChange,
  ...
  const palette = style?.colorPalette?.length ? style.colorPalette : STACKED_CHART_COLORS;
  ...
  return (
    <div className="flex-1 min-w-0 p-2 bg-transparent" style={{ height: chartHeight }}>
      <RechartsWrapper
        ...
        chartType={"stacked" as any}
        themeColors={themeColors}
        colors={palette}
        height={chartHeight}
        showOutliers={s?.timepointLine?.showOutliers !== false}
        showBrush={true}
