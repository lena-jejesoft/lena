...
export function LegendItem({
  ...
  const getSeriesType = (): "line" | "bar" | "pie" | "treemap" => {
    ...
    if ((chartType === "mixed" || chartType === "dual-axis" || chartType === "dual-axis-stacked-bar") && yFieldTypes?.[name]) {
  ...
  if (isEditMode && (chartType === 'dual-axis' || chartType === 'dual-axis-stacked-bar' || chartType === 'mixed') && onTypeChange) {
    const currentType = yFieldTypes?.[name] || 'line';
  ...
  if (isEditMode && (chartType === 'stacked-grouped' || chartType === 'dual-axis-stacked-bar') && onSeriesGroupChange) {
